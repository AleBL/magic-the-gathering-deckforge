const pt = {
  translations: {
    ...
    stats: {
      ...
      manaBaseIdeal: 'Sua base de mana está ideal para este deck!',
      ...
      sourcesAvailable: 'Fontes de Mana Disponíveis',
      symbol: 'Símbolo',
      symbolsNeeded: 'Símbolos Necessários',
    ...
    print: {
      ...
      printZoneMainMaybe: 'Deck Principal + Maybeboard',
      printZoneMainSide: 'Deck Principal + Sideboard',
      printZoneMainTokens: 'Deck Principal + Fichas',
      printZoneMaybe: 'Apenas Maybeboard',
    ...
    export: {
      ...
      qrTooLarge: 'Este deck é grande demais para um QR code — use o link ou o arquivo .deck.',
      scanHint: 'Escaneie com a câmera do celular para abrir o deck.',
      gatherer: 'Gatherer',
