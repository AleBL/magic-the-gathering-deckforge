      ...
      <div className="flex bg-gray-100/80 dark:bg-slate-800/80 backdrop-blur-sm p-1 rounded-xl shadow-inner border border-gray-200/50 dark:border-slate-700 w-full sm:w-auto">
        {CARD_SIZES.map((size) => (
          <button
            ...
            className={`flex-1 sm:flex-none text-center px-4 py-1.5 text-xs font-bold rounded-lg transition-all duration-200 ease-in-out ${selectedSize === size
                ? 'bg-white dark:bg-slate-600 text-blue-600 dark:text-blue-400 shadow-sm ring-1 ring-black/5 dark:ring-white/10 scale-105'
